...
// RAMS
//-----------------------------------------------------------------------------------
//dpram #(8,11) sram( .clk_a(SHCL), .addr_a(SHMA), .d_a(SHWD), .q_a(SHMD), .we_a(SHMW), .clk_b(CPUCL), .addr_b(CPUAD), .d_b(CPUOD), .q_b(SRMDT), .we_b(CSSRM & CPUMW));
//dpram #(8,10) cram( .clk_a(BGCL), .addr_a(BGVA), .d_a(BGVD[15:8]), .q_a(8'b0), .we_a(1'b0), .clk_b(CPUCL), .addr_b(CPUAD), .d_b(CPUOD), .q_b(CRMDT), .we_b(CSSRM & CPUMW));
//dpram #(8,10) vram( .clk_a(BGCL), .addr_a(BGVA), .d_a(BGVD[7:0]), .q_a(8'b0), .we_a(1'b0), .clk_b(CPUCL), .addr_b(CPUAD), .d_b(CPUOD), .q_b(VRMDT), .we_b(CSSRM & CPUMW));
//-----------------------------------------------------------------------------------
//DPRAM   #(11,8) sram(SHCL,SHMA,SHWD,SHMW,SHMD, CPUCL,CPUAD,CPUOD,CSSRM & CPUMW,SRMDT);
//DPRAM_1 #(10,8) cram(BGCL,BGVA,BGVD[15:8]    , CPUCL,CPUAD,CPUOD,CSCRM & CPUMW,CRMDT);
//DPRAM_2 #(10,8) vram(BGCL,BGVA,BGVD[ 7:0]    , CPUCL,CPUAD,CPUOD,CSVRM & CPUMW,VRMDT);
//-----------------------------------------------------------------------------------
RAM_B   #(12)   wram(CPUCL,CPUAD,CPUOD,CSWRM & CPUMW,WRMDT);
DPRAM   #(11,8) sram(SHCL,SHMA,SHWD,SHMW,SHMD, CPUCL,CPUAD,CPUOD,CSSRM & CPUMW,SRMDT);
